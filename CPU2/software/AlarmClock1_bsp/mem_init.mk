...
# Memory: ONCHIPRAM
MEM_0 := AlarmClockHDL_ONCHIPRAM
$(MEM_0)_NAME := ONCHIPRAM
...
$(MEM_0)_HIERARCHICAL_PATH := ONCHIPRAM
$(MEM_0)_WIDTH := 32
...
.PHONY: ONCHIPRAM
ONCHIPRAM: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
